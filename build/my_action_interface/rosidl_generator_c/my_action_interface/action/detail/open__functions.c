...
my_action_interface__action__Open_Goal__create()
{
  ...
  my_action_interface__action__Open_Goal * msg = (my_action_interface__action__Open_Goal *)allocator.allocate(sizeof(my_action_interface__action__Open_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_action_interface__action__Open_Goal));
  bool success = my_action_interface__action__Open_Goal__init(msg);
  if (!success) {
...
my_action_interface__action__Open_Goal__destroy(my_action_interface__action__Open_Goal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    my_action_interface__action__Open_Goal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
my_action_interface__action__Open_Goal__Sequence__init(my_action_interface__action__Open_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_Goal * data = NULL;

  if (size) {
    data = (my_action_interface__action__Open_Goal *)allocator.zero_allocate(size, sizeof(my_action_interface__action__Open_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_action_interface__action__Open_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_action_interface__action__Open_Goal__fini(&data[i - 1]);
      }
...
my_action_interface__action__Open_Goal__Sequence__fini(my_action_interface__action__Open_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_action_interface__action__Open_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_Goal__Sequence * array = (my_action_interface__action__Open_Goal__Sequence *)allocator.allocate(sizeof(my_action_interface__action__Open_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_action_interface__action__Open_Goal__Sequence__init(array, size);
  if (!success) {
...
my_action_interface__action__Open_Goal__Sequence__destroy(my_action_interface__action__Open_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_action_interface__action__Open_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_action_interface__action__Open_Goal__Sequence__are_equal(const my_action_interface__action__Open_Goal__Sequence * lhs, const my_action_interface__action__Open_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_action_interface__action__Open_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_action_interface__action__Open_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_action_interface__action__Open_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_action_interface__action__Open_Goal * data =
      (my_action_interface__action__Open_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_action_interface__action__Open_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_action_interface__action__Open_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_action_interface__action__Open_Goal__copy(
...
my_action_interface__action__Open_Result__init(my_action_interface__action__Open_Result * msg)
{
  ...
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->sequence, 0)) {
    my_action_interface__action__Open_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_Result * msg = (my_action_interface__action__Open_Result *)allocator.allocate(sizeof(my_action_interface__action__Open_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_action_interface__action__Open_Result));
  bool success = my_action_interface__action__Open_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_action_interface__action__Open_Result__Sequence__init(my_action_interface__action__Open_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_Result * data = NULL;

  if (size) {
    data = (my_action_interface__action__Open_Result *)allocator.zero_allocate(size, sizeof(my_action_interface__action__Open_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_action_interface__action__Open_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_action_interface__action__Open_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_action_interface__action__Open_Result__Sequence__fini(my_action_interface__action__Open_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_action_interface__action__Open_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_Result__Sequence * array = (my_action_interface__action__Open_Result__Sequence *)allocator.allocate(sizeof(my_action_interface__action__Open_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_action_interface__action__Open_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_action_interface__action__Open_Result__Sequence__destroy(my_action_interface__action__Open_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_action_interface__action__Open_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_action_interface__action__Open_Result__Sequence__are_equal(const my_action_interface__action__Open_Result__Sequence * lhs, const my_action_interface__action__Open_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_action_interface__action__Open_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_action_interface__action__Open_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_action_interface__action__Open_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_action_interface__action__Open_Result * data =
      (my_action_interface__action__Open_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_action_interface__action__Open_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_action_interface__action__Open_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_action_interface__action__Open_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_action_interface__action__Open_Feedback__init(my_action_interface__action__Open_Feedback * msg)
{
  ...
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->partial_sequence, 0)) {
    my_action_interface__action__Open_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_Feedback * msg = (my_action_interface__action__Open_Feedback *)allocator.allocate(sizeof(my_action_interface__action__Open_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_action_interface__action__Open_Feedback));
  bool success = my_action_interface__action__Open_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_action_interface__action__Open_Feedback__Sequence__init(my_action_interface__action__Open_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_Feedback * data = NULL;

  if (size) {
    data = (my_action_interface__action__Open_Feedback *)allocator.zero_allocate(size, sizeof(my_action_interface__action__Open_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_action_interface__action__Open_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_action_interface__action__Open_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_action_interface__action__Open_Feedback__Sequence__fini(my_action_interface__action__Open_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_action_interface__action__Open_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_Feedback__Sequence * array = (my_action_interface__action__Open_Feedback__Sequence *)allocator.allocate(sizeof(my_action_interface__action__Open_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_action_interface__action__Open_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_action_interface__action__Open_Feedback__Sequence__destroy(my_action_interface__action__Open_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_action_interface__action__Open_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_action_interface__action__Open_Feedback__Sequence__are_equal(const my_action_interface__action__Open_Feedback__Sequence * lhs, const my_action_interface__action__Open_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_action_interface__action__Open_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_action_interface__action__Open_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_action_interface__action__Open_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_action_interface__action__Open_Feedback * data =
      (my_action_interface__action__Open_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_action_interface__action__Open_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_action_interface__action__Open_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_action_interface__action__Open_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_action_interface__action__Open_SendGoal_Request__init(my_action_interface__action__Open_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    my_action_interface__action__Open_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!my_action_interface__action__Open_Goal__init(&msg->goal)) {
    my_action_interface__action__Open_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
my_action_interface__action__Open_SendGoal_Request__fini(my_action_interface__action__Open_SendGoal_Request * msg)
{
  ...
  // goal
  my_action_interface__action__Open_Goal__fini(&msg->goal);
}
...
my_action_interface__action__Open_SendGoal_Request__are_equal(const my_action_interface__action__Open_SendGoal_Request * lhs, const my_action_interface__action__Open_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!my_action_interface__action__Open_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_SendGoal_Request * msg = (my_action_interface__action__Open_SendGoal_Request *)allocator.allocate(sizeof(my_action_interface__action__Open_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_action_interface__action__Open_SendGoal_Request));
  bool success = my_action_interface__action__Open_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_action_interface__action__Open_SendGoal_Request__Sequence__init(my_action_interface__action__Open_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_SendGoal_Request * data = NULL;

  if (size) {
    data = (my_action_interface__action__Open_SendGoal_Request *)allocator.zero_allocate(size, sizeof(my_action_interface__action__Open_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_action_interface__action__Open_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_action_interface__action__Open_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_action_interface__action__Open_SendGoal_Request__Sequence__fini(my_action_interface__action__Open_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_action_interface__action__Open_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_SendGoal_Request__Sequence * array = (my_action_interface__action__Open_SendGoal_Request__Sequence *)allocator.allocate(sizeof(my_action_interface__action__Open_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_action_interface__action__Open_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_action_interface__action__Open_SendGoal_Request__Sequence__destroy(my_action_interface__action__Open_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_action_interface__action__Open_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_action_interface__action__Open_SendGoal_Request__Sequence__are_equal(const my_action_interface__action__Open_SendGoal_Request__Sequence * lhs, const my_action_interface__action__Open_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_action_interface__action__Open_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_action_interface__action__Open_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_action_interface__action__Open_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_action_interface__action__Open_SendGoal_Request * data =
      (my_action_interface__action__Open_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_action_interface__action__Open_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_action_interface__action__Open_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_action_interface__action__Open_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_action_interface__action__Open_SendGoal_Response__init(my_action_interface__action__Open_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    my_action_interface__action__Open_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_SendGoal_Response * msg = (my_action_interface__action__Open_SendGoal_Response *)allocator.allocate(sizeof(my_action_interface__action__Open_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_action_interface__action__Open_SendGoal_Response));
  bool success = my_action_interface__action__Open_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_action_interface__action__Open_SendGoal_Response__Sequence__init(my_action_interface__action__Open_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_SendGoal_Response * data = NULL;

  if (size) {
    data = (my_action_interface__action__Open_SendGoal_Response *)allocator.zero_allocate(size, sizeof(my_action_interface__action__Open_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_action_interface__action__Open_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_action_interface__action__Open_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_action_interface__action__Open_SendGoal_Response__Sequence__fini(my_action_interface__action__Open_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_action_interface__action__Open_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_SendGoal_Response__Sequence * array = (my_action_interface__action__Open_SendGoal_Response__Sequence *)allocator.allocate(sizeof(my_action_interface__action__Open_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_action_interface__action__Open_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_action_interface__action__Open_SendGoal_Response__Sequence__destroy(my_action_interface__action__Open_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_action_interface__action__Open_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_action_interface__action__Open_SendGoal_Response__Sequence__are_equal(const my_action_interface__action__Open_SendGoal_Response__Sequence * lhs, const my_action_interface__action__Open_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_action_interface__action__Open_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_action_interface__action__Open_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_action_interface__action__Open_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_action_interface__action__Open_SendGoal_Response * data =
      (my_action_interface__action__Open_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_action_interface__action__Open_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_action_interface__action__Open_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_action_interface__action__Open_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_action_interface__action__Open_GetResult_Request__init(my_action_interface__action__Open_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    my_action_interface__action__Open_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_GetResult_Request * msg = (my_action_interface__action__Open_GetResult_Request *)allocator.allocate(sizeof(my_action_interface__action__Open_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_action_interface__action__Open_GetResult_Request));
  bool success = my_action_interface__action__Open_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_action_interface__action__Open_GetResult_Request__Sequence__init(my_action_interface__action__Open_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_GetResult_Request * data = NULL;

  if (size) {
    data = (my_action_interface__action__Open_GetResult_Request *)allocator.zero_allocate(size, sizeof(my_action_interface__action__Open_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_action_interface__action__Open_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_action_interface__action__Open_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_action_interface__action__Open_GetResult_Request__Sequence__fini(my_action_interface__action__Open_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_action_interface__action__Open_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_GetResult_Request__Sequence * array = (my_action_interface__action__Open_GetResult_Request__Sequence *)allocator.allocate(sizeof(my_action_interface__action__Open_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_action_interface__action__Open_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_action_interface__action__Open_GetResult_Request__Sequence__destroy(my_action_interface__action__Open_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_action_interface__action__Open_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_action_interface__action__Open_GetResult_Request__Sequence__are_equal(const my_action_interface__action__Open_GetResult_Request__Sequence * lhs, const my_action_interface__action__Open_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_action_interface__action__Open_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_action_interface__action__Open_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_action_interface__action__Open_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_action_interface__action__Open_GetResult_Request * data =
      (my_action_interface__action__Open_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_action_interface__action__Open_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_action_interface__action__Open_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_action_interface__action__Open_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_action_interface__action__Open_GetResult_Response__init(my_action_interface__action__Open_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!my_action_interface__action__Open_Result__init(&msg->result)) {
    my_action_interface__action__Open_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
my_action_interface__action__Open_GetResult_Response__fini(my_action_interface__action__Open_GetResult_Response * msg)
{
  ...
  // status
  // result
  my_action_interface__action__Open_Result__fini(&msg->result);
}
...
my_action_interface__action__Open_GetResult_Response__are_equal(const my_action_interface__action__Open_GetResult_Response * lhs, const my_action_interface__action__Open_GetResult_Response * rhs)
{
  ...
  // result
  if (!my_action_interface__action__Open_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_GetResult_Response * msg = (my_action_interface__action__Open_GetResult_Response *)allocator.allocate(sizeof(my_action_interface__action__Open_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_action_interface__action__Open_GetResult_Response));
  bool success = my_action_interface__action__Open_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_action_interface__action__Open_GetResult_Response__Sequence__init(my_action_interface__action__Open_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_GetResult_Response * data = NULL;

  if (size) {
    data = (my_action_interface__action__Open_GetResult_Response *)allocator.zero_allocate(size, sizeof(my_action_interface__action__Open_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_action_interface__action__Open_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_action_interface__action__Open_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_action_interface__action__Open_GetResult_Response__Sequence__fini(my_action_interface__action__Open_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_action_interface__action__Open_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_GetResult_Response__Sequence * array = (my_action_interface__action__Open_GetResult_Response__Sequence *)allocator.allocate(sizeof(my_action_interface__action__Open_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_action_interface__action__Open_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_action_interface__action__Open_GetResult_Response__Sequence__destroy(my_action_interface__action__Open_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_action_interface__action__Open_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_action_interface__action__Open_GetResult_Response__Sequence__are_equal(const my_action_interface__action__Open_GetResult_Response__Sequence * lhs, const my_action_interface__action__Open_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_action_interface__action__Open_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_action_interface__action__Open_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_action_interface__action__Open_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_action_interface__action__Open_GetResult_Response * data =
      (my_action_interface__action__Open_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_action_interface__action__Open_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_action_interface__action__Open_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_action_interface__action__Open_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
my_action_interface__action__Open_FeedbackMessage__init(my_action_interface__action__Open_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    my_action_interface__action__Open_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!my_action_interface__action__Open_Feedback__init(&msg->feedback)) {
    my_action_interface__action__Open_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
my_action_interface__action__Open_FeedbackMessage__fini(my_action_interface__action__Open_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  my_action_interface__action__Open_Feedback__fini(&msg->feedback);
}
...
my_action_interface__action__Open_FeedbackMessage__are_equal(const my_action_interface__action__Open_FeedbackMessage * lhs, const my_action_interface__action__Open_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!my_action_interface__action__Open_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_FeedbackMessage * msg = (my_action_interface__action__Open_FeedbackMessage *)allocator.allocate(sizeof(my_action_interface__action__Open_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_action_interface__action__Open_FeedbackMessage));
  bool success = my_action_interface__action__Open_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
my_action_interface__action__Open_FeedbackMessage__Sequence__init(my_action_interface__action__Open_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_FeedbackMessage * data = NULL;

  if (size) {
    data = (my_action_interface__action__Open_FeedbackMessage *)allocator.zero_allocate(size, sizeof(my_action_interface__action__Open_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_action_interface__action__Open_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        my_action_interface__action__Open_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
my_action_interface__action__Open_FeedbackMessage__Sequence__fini(my_action_interface__action__Open_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      my_action_interface__action__Open_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_action_interface__action__Open_FeedbackMessage__Sequence * array = (my_action_interface__action__Open_FeedbackMessage__Sequence *)allocator.allocate(sizeof(my_action_interface__action__Open_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_action_interface__action__Open_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
my_action_interface__action__Open_FeedbackMessage__Sequence__destroy(my_action_interface__action__Open_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_action_interface__action__Open_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_action_interface__action__Open_FeedbackMessage__Sequence__are_equal(const my_action_interface__action__Open_FeedbackMessage__Sequence * lhs, const my_action_interface__action__Open_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_action_interface__action__Open_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_action_interface__action__Open_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_action_interface__action__Open_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_action_interface__action__Open_FeedbackMessage * data =
      (my_action_interface__action__Open_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_action_interface__action__Open_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_action_interface__action__Open_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_action_interface__action__Open_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
